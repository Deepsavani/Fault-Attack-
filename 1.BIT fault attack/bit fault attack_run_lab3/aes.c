...
// static void aes128_key_schedule_inv_round(uint8_t p_key[128], uint8_t rcon)
// {
//     uint_fast8_t    round;
//     uint8_t       * p_key_0 = p_key + 128 - 32;
//     uint8_t       * p_key_m1 = p_key_0 - 32;

//     for (round = 1; round < 128 / 32; ++round)
//     {
...
//     p_key_m1 = p_key + 128 - 32;
//     p_key_0[0] ^= getSBoxValue(p_key_m1[1]) ^ rcon;
//     p_key_0[1] ^= getSBoxValue(p_key_m1[2]);
//     p_key_0[2] ^= getSBoxValue(p_key_m1[3]);
//     p_key_0[3] ^= getSBoxValue(p_key_m1[0]);
// }
//---------------------------------------------------------------------------------------------//
...
static void InvShiftRows2(state_t* state)
{
  uint8_t temp;
